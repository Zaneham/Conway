; test_jal_pc.asm - Check PC after JAL
bits 64
default rel
...
section .data
    ...
    test_program:
        ...
        dd 0x0080006F       ; PC=8: jal x0, 8 -> should go to PC=16

        dd 0x00000000       ; PC=12: padding

        ; Block 2: PC=16
        dd 0x00F00193       ; PC=16: addi x3, x0, 15
        dd 0x00000063       ; PC=20: beq x0, x0, 0
...
.clear:
    ...
    ; Exit with PC - should be 16 if JAL worked correctly
    mov ecx, [rv_pc]
    call ExitProcess
