; test_exec_two.asm - execute_blocks with 2 blocks via branch
bits 64
default rel
...
section .data
    ...
    test_program:
        ...
        dd 0x00000463       ; PC=4: beq x0, x0, 8 -> PC=12 (block 2)

        ; Padding: PC=8
        dd 0x00000000       ; PC=8: should be skipped
...
.clear:
    ...
    ; Exit with x1 + x2 (should be 5 + 10 = 15 if both blocks ran)
    mov eax, [rv_regs + 1*8]
    add eax, [rv_regs + 2*8]
    mov ecx, eax
    call ExitProcess
